...
public class NewPdf {
    ...
    private static void drawCircleOnNewPage(PdfDocument pdfDoc) {
        ...
        canvas.circle(100, 741, 2);  // lewa góra
        canvas.circle(495, 741, 2); // prawa góra
        canvas.fill();
        canvas.rectangle(new Rectangle(198, 413, 200, 15))

                .rectangle(new Rectangle(0, 0, 100, 100))
                .rectangle(new Rectangle(495, 0, 100, 100))
                .rectangle(new Rectangle(0, 741, 100, 100))
                .rectangle(new Rectangle(495, 741, 100, 100));
        ...
        canvas.moveTo(100, 100).lineTo(495, 741);
        canvas.moveTo(495, 100).lineTo(100, 741);
        canvas.stroke();
    }
}
